...
public class CreacionDatosIniciales {
    public static void insertarDatos() throws InvalidKeySpecException, NoSuchAlgorithmException {
        final ArchivoCacheado blacklistFile = new ArchivoCacheado("/10k-most-common.txt", 4563);
        final ArchivoCacheado owaspFile = new ArchivoCacheado("/password-blacklist.txt", 5555);

        ValidadorPasswords validadorPasswords1 = new ValidadorPasswords(
                Arrays.asList(
