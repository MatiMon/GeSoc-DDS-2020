...
public class Tarjeta implements MediosDePago {
    ...
    Tarjeta(TipoTarjeta unTipo, String numTarj, String codSeg,String nombre, java.util.Date vencimineto, BigDecimal lim ){
        tipo = unTipo;
        numTarjeta = this.verificarNumerosIngrasados(numTarj,16,"Numero Tarjeta");
